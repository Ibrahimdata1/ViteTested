...
const CardboxSlide = (props: productDataProps) => {
  ...
  return (
    <div
      ...
      style={{ maxHeight: "320px", maxWidth: "200px", cursor:'pointer' }}
      onMouseOver={()=>setIsHovering(true)}
      onMouseOut={()=>setIsHovering(false)}
    >
      <img src={props.imgURL} alt="book1" className="product--img" />
      <div className={`align-items-center d-flex flex-column lh-1 mt-0 pt-0 px-0 w-100 rounded ${isHovering? 'bgColor':''}`}style={{maxWidth:'170px'}}>
        <h3>{props.name}</h3>
